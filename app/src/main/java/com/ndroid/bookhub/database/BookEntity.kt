...
@Entity(tableName = "books")    //this is called annotation
//annotations are used to tell the compiler what we are creating
data class BookEntity(
    @PrimaryKey val book_id: Int,       //Named differently as it is following the database convention
